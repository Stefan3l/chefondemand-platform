...
export default function DashboardPage() {
  ...
  // doar UI-ul central; shell-ul e furnizat de (dashboard)/layout.tsx
      ...
      <section className="my-8">
        ...
        <div className="grid gap-4 grid-cols-1 lg:grid-cols-3">
          {[
            ...
            <div
              key={s.label}
              className="rounded-2xl border border-[#C7AE6A33] bg-neutral-900 p-4 hover:-translate-y-[2px] hover:bg-[#2D291F] hover:border-[#C7AE6A] transition-transform duration-200 "
            >
